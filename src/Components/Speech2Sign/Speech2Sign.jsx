...
export default function Speech2Sign() {
  ...
  const handleSend = async () => {
    const url =
      "https://backenedstasl-afhsftauc6hbetb3.canadacentral-01.azurewebsites.net/asl";
    console.log("Clicked");
  ...
  return (
    <>
      <div>
        <div className="w-1/2 mx-auto flex flex-col items-center mt-32  ">
          <h2 className="font-inter text-xl font-semibold"> Speak Here</h2>
          <button
